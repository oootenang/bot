...
auth: state,
browser: [`Jadibot Md By (Ikhsan-BOT)`, "Chrome", "1.0.0"],
...
await m.reply(`*Connected to Whatsapp Jika Ingin Memberhentikan Langsung Log Out Aja - Bot*\n\n*User :*\n _*× id : ${kayla.decodeJid(kayla.user.id)}*_`)
user = `${kayla.decodeJid(kayla.user.id)}`
txt = `*Terdeteksi menumpang Jadibot*\n\n _× User : @${user.split("@")[0]}_`
sendMessage(`6285756448056@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
