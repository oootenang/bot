...
${hituet+=1} ${prefix}createakun 🅞
${hituet+=1} ${prefix}listakun 🅞
${hituet+=1} ${prefix}killakun 🅞
...
${hituet+=1} ${prefix}resetlink 🅖
${hituet+=1} ${prefix}promote 🅖
${hituet+=1} ${prefix}demote 🅖
${hituet+=1} ${prefix}hidetag 🅖
${hituet+=1} ${prefix}setdesc 🅖
${hituet+=1} ${prefix}setnamegc 🅖
${hituet+=1} ${prefix}group open/close 🅖
